...
<div class="container">
    ...
    <br>
    <a href="trackstar.php?addProject" style="color:black"><h3>+ Projekt erstellen</h3></a>
    <table class="table table-striped table-hover">
	    ...
	    <tbody>			
			...
			<tr>
				...
				<?php echo '<td><a href="trackstar.php?delete='.$row->id.'" style="color:black"><span class="glyphicon glyphicon-trash"></span></a>
				<a href="trackstar.php?editProject='.$row->id.'" style="color:black"><span class="glyphicon glyphicon-pencil"></span></a>				
				</td>';
				?>
			</tr>				
	 		<?php endforeach; 	 ?>
	  ...
	  <nav aria-label="Page navigation">
		<ul class="pagination">
			<li>
			<a href="trackstar.php?page=0" aria-label="First">
			...
			{			
				...
				if($active==false){
					echo '<li><a href="trackstar.php?page='.$i.'">'.$displayi.'</a></li>';
				}
				else
				{
					echo '<li class="active"><a href="trackstar.php?page='.$i.'">'.$displayi.'</a></li>';
				}
				$lastpage=$i;
			}
		echo "<li>";
		echo '<a href="trackstar.php?page='.$lastpage.'" aria-label="Last">';
